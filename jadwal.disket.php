...
function DftrJdwl() {
  ...
  while ($w = _fetch_array($r)) {
    ...
    echo "<tr><td class=inp>$n</td>
	  ...
	  <td class=ul align=center><a href='cetak.label.disket.php?JadwalID=$w[JadwalID]&tahun=$_SESSION[tahun]&prodi=$_SESSION[prodi]&prid=$_SESSION[prid]&asal=1' title='Cetak Label Disket'>Label</a></td>
