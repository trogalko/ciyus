...
function DaftarProdiUSM() {
  ...
  while ($w = _fetch_array($r)) {
    $ctklbl = "<a href='pmb.cetak.label.php?prodi=$_SESSION[prodi]&prodiusmid=$w[ProdiUSMID]&pmbusmid=$w[PMBUSMID]&pmbaktif=$_SESSION[tahunpmb]'><img src='img/printer.gif' border=0></a>";
    $ctkdhu = "<a href='pmb.cetak.dhu.php?prodi=$_SESSION[prodi]&prodiusmid=$w[ProdiUSMID]&pmbusmid=$w[PMBUSMID]&pmbaktif=$_SESSION[tahunpmb]'><img src='img/printer.gif' border=0></a>";
